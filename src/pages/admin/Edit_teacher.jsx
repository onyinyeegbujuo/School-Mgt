  ...
  return (
    <div>
        <div className='mx-5 py-6'>
            <h1 className='text-center text-2xl text-primary font-semibold mb-5'>Edit Teacher</h1>
            <div className='lg:w-2xl mx-auto  bg-white rounded-lg py-3 w-[310px]'>
                <form action="" method='' className='py-5 px-5'>
                    ...
                    <div className='lg:w-xl w-[270px] flex gap-3'>
                        <button type='' name='' className='w-full px-3 py-2 outline-hidden text-white font-semibold lg:w-[400px] bg-secondary rounded-lg'>EDIT  </button>
